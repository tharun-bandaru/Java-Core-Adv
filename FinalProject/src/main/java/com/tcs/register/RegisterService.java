...
public class RegisterService extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * int count =
		 * UserDAO.save(username,password,finalQual,gender,finalTech,country,finaladdrs,
		 * review); if(count==1) { writer.println("Data inserted successfully....");
		 * writer.println("<br><br>");
		 * writer.println("<a href='login.html'>Click here to login</a>"); } else {
